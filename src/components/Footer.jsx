...
const Footer = () => {
  return (
    <footer className="bg-[#24452D] text-white relative z-50">
        ...
        <div className="hidden md:grid md:grid-cols-4 md:gap-8 lg:gap-12">
          ...
          <div className="col-span-1 flex flex-col justify-start items-center gap-10">
            ...
            <div className="flex justify-center items-center gap-2">
              <button className="w-10 h-10 bg-transparent rounded flex items-center justify-center hover:bg-[#A4781A] transition-all duration-300">
                {/* YouTube Icon */}
